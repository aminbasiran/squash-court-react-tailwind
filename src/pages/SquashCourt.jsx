...
const SquashCourt = () => {
    ...
    // const[courtIsLoading,setCourtIsLoading] = useState(true)
    ...
    return (
        <div ref={parentRef} className='main h-full overflow-y-scroll '>
            <h1 className='text-3xl font-extrabold mb-2 dark:text-white transition-all duration-500 ease-in-out'>Squash Finder</h1>
            <p className='text-zinc-600 text-md font-medium dark:text-white transition-all duration-500 ease-in-out'>Play Anywhere, Anytime: Find squash courts here in Malaysia. <span className="hover:cursor-pointer text-fuchsia-600">Feel free to contribute.</span></p>
